...
public:
	...
	bool	m_b;						// this + 0x793 / 1939.	maybe it is 'ITEM_FLAG_SKILLSHOTS'. used by pistols to one shots in head.
	...
	bool 	m_b;						// this + 0x7CF / 1999.	maybe it is 'ITEM_FLAG_PENETRATION'. used by heavy power guns to one shot double kills.
	...
	bool 	m_b2;						// this + 0x7F0 / 2032. maybe it is 'MeleeWeapon', mark this weapon as melee weapon.
